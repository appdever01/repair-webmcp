  ...
  return (
    <section className="analysis-panel" id="object-analysis" aria-labelledby="analysis-title">
      <div className="analysis-heading">
        <div>
          <p className="eyebrow">What the photo suggests</p>
          {editingName ? (
            <form
              className="name-edit"
              onSubmit={(event) => {
        ...
        {!editingName && (
          <button type="button" className="text-button" onClick={() => setEditingName(true)}>
      ...
      <div className="uncertainty-note">
        ...
        <p>
          These are hypotheses from one image, not a diagnosis. Hidden damage, exact materials, and
          internal condition remain unknown until a person checks them safely.
        </p>
      </div>
